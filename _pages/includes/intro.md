...
in top-tier journals and conferences, including IJCV, IEEE T-IFS, IEEE T-NNLS, IEEE T-IM, IEEE T-CSVT, IEEE J-BHI, IEEE J-STSP, MICCAI, WWW, and others. Additionally, I have served as a reviewer for several prestigious journals and conferences, such as IEEE T-IFS, IEEE T-MI, IEEE T-MM, IEEE T-CSVT, IEEE T-SMCS, IEEE T-II, IEEE SPL, IEEE IoTJ, IEEE J-BHI, CVPR, and MICCAI, among others.
