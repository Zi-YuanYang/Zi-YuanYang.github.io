...
in top-tier journals and conferences, including IJCV, IEEE T-IFS, IEEE T-NNLS, IEEE T-IM, IEEE T-CSVT, IEEE J-BHI, IEEE J-STSP, MICCAI, WWW, and others. Additionally, I have served as a reviewer for several prestigious journals and conferences, such as IEEE T-IFS, IEEE T-MI, IEEE T-MM, IEEE T-NNLS, IEEE T-CSVT, IEEE T-SMCS, IEEE T-II, IEEE T-BC, CVPR, and MICCAI, among others.
